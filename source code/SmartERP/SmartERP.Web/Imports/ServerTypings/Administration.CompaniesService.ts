namespace SmartERP.Administration {
    export namespace CompaniesService {
        export const baseUrl = 'Administration/Companies';
        ...
        export declare function GetDefaultCurrency(request: GetDefaultCurrencyRequest, onSuccess?: (response: GetDefaultCurrencyResponse) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
