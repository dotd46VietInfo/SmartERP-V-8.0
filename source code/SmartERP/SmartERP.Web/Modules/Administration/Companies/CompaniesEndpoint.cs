...
namespace SmartERP.Administration.Endpoints
{
    ...
    [Route("Services/Administration/Companies/[action]")]
    ...
    public class CompaniesController : ServiceEndpoint
    {
        ...
        public GetDefaultCurrencyResponse GetDefaultCurrency(IDbConnection connection, GetDefaultCurrencyRequest request,
            [FromServices] ICompanyGetDefaultCurrencyHandler handler)
        {
            return handler.GetDefaultCurrency(connection, request);
        }
    }
}
