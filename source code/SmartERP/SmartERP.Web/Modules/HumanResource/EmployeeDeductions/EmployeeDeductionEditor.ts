...
namespace SmartERP.HumanResource {
    ...
    export class EmployeeDeductionEditor extends Serenity.Extensions.GridEditorBase<EmployeeDeductionsRow> {
        ...
        protected validateEntity(row: EmployeeDeductionsRow, id: number) {
