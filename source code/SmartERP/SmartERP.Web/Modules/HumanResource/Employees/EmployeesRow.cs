...
namespace SmartERP.HumanResource.Entities
{
    ...
    public sealed class EmployeesRow : SmartERP.LoggingRow<EmployeesRow.RowFields>, IIdRow, INameRow
    {
        ...
        //[MasterDetailRelation(foreignKey: "Employee")]
        //[DisplayName("Bank Accounts"), NotMapped]
        //public List<EmployeeBankAccountsRow> EmployeeBankAccounts
        //{
        //    get { return Fields.EmployeeBankAccounts[this]; }
        //    set { Fields.EmployeeBankAccounts[this] = value; }
        //}
        ...
        public List<EmployeeIncomesRow> IncomeList
        {
        ...
        public List<EmployeeDeductionsRow> DeductionList
        {
            get => fields.DeductionList[this];
            set => fields.DeductionList[this] = value;
        }

        [DisplayName("Payroll Bank Name"), NotNull, ForeignKey("[dbo].[Banks]", "Id"), LeftJoin("jBankName"), TextualField("PayrollBankName")]
        [LookupEditor(typeof(BanksRow))]
        public Int64? PayrollBankId
        {
            get { return Fields.PayrollBankId[this]; }
            set { Fields.PayrollBankId[this] = value; }
        }
        [DisplayName("Bank Name For Payroll"), Expression("jBankName.[BankName]"), MinSelectLevel(SelectLevel.List)]
        public String PayrollBankName
        {
            get { return Fields.PayrollBankName[this]; }
            set { Fields.PayrollBankName[this] = value; }
        }
        [DisplayName("Bank Account For Payroll"), Size(200), NotNull]
        ...
        public class RowFields : SmartERP.LoggingRowFields
        {
            ...
            public RowListField<EmployeeIncomesRow> IncomeList;

            public RowListField<EmployeeDeductionsRow> DeductionList;

            public Int64Field PayrollBankId;
            public StringField PayrollBankName;
