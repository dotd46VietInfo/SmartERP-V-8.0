...
namespace SmartERP.Masters
{
    ...
    public class PermissionKeys
    {
        ...
        {
            public const string View = "Masters:Incomes:View";
            public const string Create = "Masters:Incomes:Create";
            public const string Update = "Masters:Incomes:Update";
            public const string Delete = "Masters:Incomes:Delete";
        }
        [DisplayName("Deductions")]
        public class Deductions
        {
            public const string View = "Masters:Deductions:View";
            public const string Create = "Masters:Deductions:Create";
            public const string Update = "Masters:Deductions:Update";
            public const string Delete = "Masters:Deductions:Delete";
        }
    }
}
